...
## Pré-requisitos (Windows 11 + WSL Ubuntu)
...
# Configurar /etc/hosts para Ingress (no Windows: C:\Windows\System32\drivers\etc\hosts)
# Descobrir IP do WSL:
hostname -I | awk '{print $1}'
...
Plataforma de gerenciamento Kubernetes com GUI web, RBAC, catálogo de apps e multi-cluster.
...
| Doc | Conteúdo |
|-----|----------|
| [`docs/arquitetura-infra.md`](docs/arquitetura-infra.md) | Diagrama da infraestrutura |
